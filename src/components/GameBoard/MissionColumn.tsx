...
interface MissionColumnProps {
  ...
  onMissionClick?: (missionIndex: number) => void;
  ...
  return (
    ...
    >
      ...
      <div className="mission-column__mission">
        ...
        {/* Dilemmas under mission */}
        {dilemmas.length > 0 && (
          <div className="mission-column__dilemmas">
            {dilemmas.map((dilemma, idx) => (
              <div
                key={dilemma.uniqueId || idx}
                className={`mission-column__dilemma ${dilemma.faceup ? "mission-column__dilemma--faceup" : ""}`}
              >
                {dilemma.faceup ? (
                  <CardSlot
                    card={dilemma}
                  ...
                  <div className="mission-column__dilemma-back" />
                )}
              </div>
            ))}
          </div>
