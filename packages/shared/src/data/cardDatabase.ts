...
const dilemmas: Record<string, DilemmaCard> = {
  ...
  EN03016: {
    ...
    rule: {
      type: "unlessCheck",
      requirements: [
        { skills: ["Anthropology", "Security", "Security"] },
        {
          skills: ["Exobiology", "Honor"],
          attribute: "Integrity",
          attributeThreshold: 32,
        },
      ],
      penalty: { type: "randomKillWithSkill", skill: "Treachery" },
    },
  ...
  EN03030: {
    ...
    lore: "You hoped that something like this would happen, didn't you? You knew there was a dangerous creature on this planet. And you knew from the tale of Darmok that a danger shared might sometimes bring two people together.",
  ...
  EN01008: {
    ...
    rule: {
      type: "unlessCheck",
      requirements: [
        { skills: ["Anthropology", "Anthropology"], singlePersonnel: true },
        { skills: ["Archaeology", "Archaeology"], singlePersonnel: true },
      ],
      penalty: {
        type: "chooseMatchingToStopElseStopAll",
        skills: ["Anthropology", "Archaeology"],
      },
    },
  ...
  EN03010: {
    ...
    rule: {
      ...
      requirements: [
        { skills: ["Anthropology", "Anthropology"], singlePersonnel: true },
        { skills: ["Security", "Security"], singlePersonnel: true },
      ],
      penalty: {
        type: "chooseMatchingToStopElseStopAll",
        skills: ["Anthropology", "Security"],
      },
    },
